...
class TestCostCalculator:
    ...
    def test_openai_gpt35_turbo_cost(self):
        ...
        cost_cents = CostCalculator.calculate_cost_cents(
            model_name="gpt-3.5-turbo", input_tokens=1000, output_tokens=500
        )
    ...
    def test_anthropic_claude_cost(self):
        ...
        cost_cents = CostCalculator.calculate_cost_cents(
            model_name="claude-3-haiku", input_tokens=1000, output_tokens=500
        )
    ...
    def test_google_gemini_cost(self):
        ...
        cost_cents = CostCalculator.calculate_cost_cents(
            model_name="gemini-pro", input_tokens=1000, output_tokens=500
        )
    ...
    def test_privatemode_tee_cost(self):
        ...
        cost_cents = CostCalculator.calculate_cost_cents(
            model_name="privatemode-llama-70b", input_tokens=1000, output_tokens=500
        )
    ...
    def test_embedding_cost(self):
        ...
        cost_cents = CostCalculator.calculate_cost_cents(
            model_name="text-embedding-ada-002", input_tokens=1000, output_tokens=0
        )
    ...
    def test_unknown_model_cost(self):
        ...
        cost_cents = CostCalculator.calculate_cost_cents(
            model_name="unknown-model", input_tokens=1000, output_tokens=500
        )
    ...
    def test_zero_tokens_cost(self):
        ...
        cost_cents = CostCalculator.calculate_cost_cents(
            model_name="gpt-3.5-turbo", input_tokens=0, output_tokens=0
        )
    ...
    def test_large_token_count_cost(self):
        ...
        cost_cents = CostCalculator.calculate_cost_cents(
            model_name="gpt-3.5-turbo", input_tokens=100000, output_tokens=50000
        )
    ...
    def test_estimate_request_cost(self):
        ...
        cost_cents = CostCalculator.estimate_cost_cents(
            model_name="gpt-3.5-turbo", estimated_tokens=1000
        )
    ...
    def test_cost_precision(self):
        ...
        cost_cents = CostCalculator.calculate_cost_cents(
            model_name="gpt-3.5-turbo", input_tokens=1, output_tokens=1
        )
    ...
    def test_model_normalization(self):
        ...
        cost2 = CostCalculator.calculate_cost_cents(
            model_name="openai/gpt-3.5-turbo", input_tokens=1000, output_tokens=500
        )
