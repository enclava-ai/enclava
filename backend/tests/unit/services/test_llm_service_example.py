...
class TestLLMService:
    ...
    async def test_content_filtering_input(self, llm_service):
        ...
        with patch.object(
            llm_service.security_service, "analyze_request"
        ) as mock_security:
    ...
    async def test_content_filtering_output(self, llm_service, sample_chat_request):
        ...
        with patch.object(
            ...
            with patch.object(
                llm_service.security_service, "analyze_response"
            ) as mock_security:
    ...
    async def test_response_time_logging(self, llm_service, sample_chat_request):
        ...
        with patch.object(
            ...
            with patch.object(
                llm_service.metrics_service, "record_request"
            ) as mock_metrics:
                await llm_service.chat_completion(sample_chat_request)
...
class TestLLMServiceIntegration:
    ...
    @pytest.mark.asyncio
    async def test_full_chat_flow_with_budget(
        ...
        with patch.object(llm_service.budget_service, "check_budget") as mock_budget:
            ...
            with patch.object(
                ...
                response = await llm_service.chat_completion(
                    sample_chat_request, user_id=test_user.id
                )
