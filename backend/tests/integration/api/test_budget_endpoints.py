...
Priority: app/api-internal/v1/budgets.py
...
class TestBudgetEndpoints:
    ...
    async def test_list_budgets_success(
        self, client, auth_headers, mock_user, sample_budget
    ):
        ...
        with patch("app.api.v1.budgets.get_current_user") as mock_get_user:
            ...
            with patch("app.api.v1.budgets.get_db") as mock_get_db:
                ...
                response = await client.get(
                    "/api-internal/v1/budgets/", headers=auth_headers
                )
    ...
    async def test_list_budgets_unauthorized(self, client):
        ...
        response = await client.get("/api-internal/v1/budgets/")
    ...
    async def test_list_budgets_with_filters(self, client, auth_headers, mock_user):
        ...
        with patch("app.api.v1.budgets.get_current_user") as mock_get_user:
            ...
            with patch("app.api.v1.budgets.get_db") as mock_get_db:
                ...
                response = await client.get(
                    "/api-internal/v1/budgets/?budget_type=dollars&period_type=monthly&active_only=true",
        ...
        with patch("app.api.v1.budgets.get_current_user") as mock_get_user:
            ...
            with patch("app.api.v1.budgets.get_db") as mock_get_db:
                ...
                response = await client.post(
                    "/api-internal/v1/budgets/", json=budget_data, headers=auth_headers
                )
    ...
    async def test_create_budget_invalid_data(self, client, auth_headers, mock_user):
        ...
        for invalid_data in invalid_cases:
            response = await client.post(
                "/api-internal/v1/budgets/", json=invalid_data, headers=auth_headers
            )
    ...
    @pytest.mark.asyncio
    async def test_get_budget_by_id_success(
        self, client, auth_headers, mock_user, sample_budget
    ):
        ...
        with patch("app.api.v1.budgets.get_current_user") as mock_get_user:
            ...
            with patch("app.api.v1.budgets.get_db") as mock_get_db:
                ...
                response = await client.get(
                    f"/api-internal/v1/budgets/{budget_id}", headers=auth_headers
                )
        ...
        with patch("app.api.v1.budgets.get_current_user") as mock_get_user:
            ...
            with patch("app.api.v1.budgets.get_db") as mock_get_db:
                ...
                response = await client.patch(
                    f"/api-internal/v1/budgets/{budget_id}",
                    json=update_data,
                    headers=auth_headers,
                )
    ...
    async def test_update_budget_invalid_data(
        ...
        budget_id = 1
        invalid_data = {"limit_amount": -100.0}  # Invalid negative amount
    ...
    async def test_get_budget_status(
        ...
        with patch("app.api.v1.budgets.get_current_user") as mock_get_user:
            ...
            with patch("app.api.v1.budgets.get_db") as mock_get_db:
                ...
                response = await client.get(
                    f"/api-internal/v1/budgets/{budget_id}/status", headers=auth_headers
                )
    ...
    @pytest.mark.asyncio
    async def test_get_budget_usage_history(
        self, client, auth_headers, mock_user, sample_budget
    ):
        ...
        with patch("app.api.v1.budgets.get_current_user") as mock_get_user:
            ...
            with patch("app.api.v1.budgets.get_db") as mock_get_db:
                ...
                mock_usage_result.scalars.return_value.all.return_value = (
                    mock_usage_records
                )
                ...
                response = await client.get(
                    f"/api-internal/v1/budgets/{budget_id}/usage", headers=auth_headers
                )
    ...
    @pytest.mark.asyncio
    async def test_reset_budget_usage(
        self, client, auth_headers, mock_user, sample_budget
    ):
        ...
        with patch("app.api.v1.budgets.get_current_user") as mock_get_user:
            ...
            with patch("app.api.v1.budgets.get_db") as mock_get_db:
                ...
                response = await client.post(
                    f"/api-internal/v1/budgets/{budget_id}/reset", headers=auth_headers
                )
    ...
    async def test_admin_list_all_budgets(self, client, admin_headers, mock_admin_user):
        ...
        with patch("app.api.v1.budgets.get_current_user") as mock_get_user:
            ...
            with patch("app.api.v1.budgets.get_db") as mock_get_db:
                ...
                response = await client.get(
                    "/api-internal/v1/budgets/admin/all", headers=admin_headers
                )
    ...
    @pytest.mark.asyncio
    async def test_admin_create_user_budget(
        ...
        with patch("app.api.v1.budgets.get_current_user") as mock_get_user:
            ...
            with patch("app.api.v1.budgets.get_db") as mock_get_db:
                ...
                response = await client.post(
                    "/api-internal/v1/budgets/admin/create",
                    json=budget_data,
    ...
    async def test_non_admin_access_denied(self, client, auth_headers, mock_user):
        ...
        response = await client.get(
            "/api-internal/v1/budgets/admin/all", headers=auth_headers
        )
    ...
    @pytest.mark.asyncio
    async def test_budget_alert_configuration(
        self, client, auth_headers, mock_user, sample_budget
    ):
        ...
        with patch("app.api.v1.budgets.get_current_user") as mock_get_user:
            ...
            with patch("app.api.v1.budgets.get_db") as mock_get_db:
                ...
                response = await client.post(
                    f"/api-internal/v1/budgets/{budget_id}/alerts",
                    json=alert_config,
                    headers=auth_headers,
                )
    ...
    @pytest.mark.asyncio
    async def test_budget_concurrent_modification(
        self, client, auth_headers, mock_user, sample_budget
    ):
        ...
        with patch("app.api.v1.budgets.get_current_user") as mock_get_user:
            ...
            with patch("app.api.v1.budgets.get_db") as mock_get_db:
                ...
                mock_session.commit.side_effect = OptimisticLockError(
                    "Record was modified", None, None, None
                )
                ...
                assert (
                    ...
                    or "modified" in data["detail"].lower()
                )
