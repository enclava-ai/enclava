...
class TestRAGEndpoints:
    ...
    async def test_get_collections_success(
        self, client, auth_headers, mock_user, sample_collection
    ):
            ...
            with patch("app.api.v1.rag.get_db") as mock_get_db:
                ...
                with patch("app.api.v1.rag.RAGService") as mock_rag_service:
                    ...
                    response = await client.get(
                        "/api/v1/rag/collections", headers=auth_headers
                    )
        ...
        with patch("app.api.v1.rag.get_current_user") as mock_get_user:
            ...
            with patch("app.api.v1.rag.get_db") as mock_get_db:
                ...
                with patch("app.api.v1.rag.RAGService") as mock_rag_service:
                    ...
                    response = await client.get(
                        "/api/v1/rag/collections?skip=10&limit=5", headers=auth_headers
                    )

                    assert response.status_code == status.HTTP_200_OK

                    # Verify pagination parameters were passed
                    mock_service.get_all_collections.assert_called_once_with(
                        skip=10, limit=5
                    )
        ...
        with patch("app.api.v1.rag.get_current_user") as mock_get_user:
            ...
            with patch("app.api.v1.rag.get_db") as mock_get_db:
                ...
                with patch("app.api.v1.rag.RAGService") as mock_rag_service:
                    mock_service = AsyncMock()
                    mock_rag_service.return_value = mock_service
                    mock_service.create_collection.side_effect = Exception(
    ...
    async def test_create_collection_invalid_data(
        ...
        for invalid_data in invalid_data_cases:
            response = await client.post(
                "/api/v1/rag/collections", json=invalid_data, headers=auth_headers
            )
            ...
            with patch("app.api.v1.rag.get_db") as mock_get_db:
                ...
                with patch("app.api.v1.rag.RAGService") as mock_rag_service:
                    ...
                    response = await client.delete(
                        f"/api/v1/rag/collections/{collection_id}", headers=auth_headers
                    )
        ...
        with patch("app.api.v1.rag.get_current_user") as mock_get_user:
            ...
            with patch("app.api.v1.rag.get_db") as mock_get_db:
                ...
                with patch("app.api.v1.rag.RAGService") as mock_rag_service:
                    mock_service = AsyncMock()
                    mock_rag_service.return_value = mock_service
                    mock_service.delete_collection.side_effect = Exception(
            ...
            with patch("app.api.v1.rag.get_db") as mock_get_db:
                ...
                with patch("app.api.v1.rag.RAGService") as mock_rag_service:
                    ...
                    assert (
                        ...
                        or "file type" in data["detail"].lower()
                    )
    ...
    @pytest.mark.asyncio
    async def test_get_documents_in_collection(
        self, client, auth_headers, mock_user, sample_document
    ):
        ...
        with patch("app.api.v1.rag.get_current_user") as mock_get_user:
            ...
            with patch("app.api.v1.rag.get_db") as mock_get_db:
                ...
                with patch("app.api.v1.rag.RAGService") as mock_rag_service:
                    ...
                    response = await client.delete(
                        f"/api/v1/rag/documents/{document_id}", headers=auth_headers
                    )
            ...
            with patch("app.api.v1.rag.get_db") as mock_get_db:
                ...
                with patch("app.api.v1.rag.RAGService") as mock_rag_service:
                    ...
                    response = await client.post(
                        ...
                        json={"query": search_query, "top_k": 5, "min_score": 0.7},
                        headers=auth_headers,
                    )
                    ...
                    assert (
                        data["results"][0]["score"] >= data["results"][1]["score"]
                    )  # Sorted by score
        ...
        with patch("app.api.v1.rag.get_current_user") as mock_get_user:
            ...
            with patch("app.api.v1.rag.get_db") as mock_get_db:
                ...
                with patch("app.api.v1.rag.RAGService") as mock_rag_service:
                    ...
                    response = await client.post(
                        f"/api/v1/rag/collections/{collection_id}/search",
                        json={"query": "nonexistent topic xyz123", "top_k": 5},
                        headers=auth_headers,
                    )
                ...
                with patch("app.api.v1.rag.RAGService") as mock_rag_service:
                    ...
                    response = await client.post(
                        ...
                        json={
                            ...
                            "top_k": 5,
                            "filters": {"chapter": 1, "author": "John Doe"},
                        },
                        headers=auth_headers,
                    )
    ...
    async def test_get_rag_stats_success(self, client, auth_headers, mock_user):
        ...
        stats_data = {
            "collections": {"total": 5, "active": 4, "processing": 1},
            "documents": {"total": 150, "completed": 140, "processing": 8, "failed": 2},
            "storage": {"total_bytes": 104857600, "total_human": "100 MB"},  # 100MB
            "vectors": {"total": 15000, "avg_per_document": 100},
        }
        ...
        with patch("app.api.v1.rag.get_current_user") as mock_get_user:
            ...
            with patch("app.api.v1.rag.get_db") as mock_get_db:
                ...
                with patch("app.api.v1.rag.RAGService") as mock_rag_service:
                    ...
                    response = await client.get(
                        "/api/v1/rag/stats", headers=auth_headers
                    )
        ...
        with patch("app.api.v1.rag.get_current_user") as mock_get_user:
            ...
            with patch("app.api.v1.rag.get_db") as mock_get_db:
                ...
                with patch("app.api.v1.rag.RAGService") as mock_rag_service:
                    mock_service = AsyncMock()
                    mock_rag_service.return_value = mock_service
                    mock_service.get_documents.side_effect = Exception(
                        "Collection not found"
                    )
        ...
        with patch("app.api.v1.rag.get_current_user") as mock_get_user:
            ...
            with patch("app.api.v1.rag.get_db") as mock_get_db:
                ...
                with patch("app.api.v1.rag.RAGService") as mock_rag_service:
                    mock_service = AsyncMock()
                    mock_rag_service.return_value = mock_service
                    mock_service.get_all_collections.side_effect = ConnectionError(
