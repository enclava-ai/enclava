...
Priority: app/api-internal/v1/analytics.py
...
class TestAnalyticsEndpoints:
    ...
    async def test_get_usage_metrics_success(
        self, client, auth_headers, mock_user, sample_metrics
    ):
        ...
        mock_analytics_service.get_usage_metrics = AsyncMock(
            return_value=Mock(**sample_metrics)
        )
        ...
        try:
            with patch(
                "app.api.v1.analytics.get_analytics_service"
            ) as mock_get_analytics:
                mock_get_analytics.return_value = mock_analytics_service

                response = await client.get(
                    "/api-internal/v1/analytics/metrics?hours=24", headers=auth_headers
                )
    ...
    @pytest.mark.asyncio
    async def test_get_usage_metrics_custom_period(
        ...
        with patch("app.api.v1.analytics.get_current_user") as mock_get_user:
            ...
            with patch("app.api.v1.analytics.get_db") as mock_get_db:
                ...
                with patch(
                    ...
                    response = await client.get(
                        "/api-internal/v1/analytics/metrics?hours=168",  # 7 days
    ...
    @pytest.mark.asyncio
    async def test_get_usage_metrics_invalid_hours(
        self, client, auth_headers, mock_user
    ):
        ...
        for case in test_cases:
            response = await client.get(
                f"/api-internal/v1/analytics/metrics?hours={case['hours']}",
                headers=auth_headers,
            )
    ...
    async def test_get_usage_metrics_unauthorized(self, client):
        ...
        response = await client.get("/api-internal/v1/analytics/metrics")
    ...
    @pytest.mark.asyncio
    async def test_get_system_metrics_admin_success(
        self, client, admin_headers, mock_admin_user, sample_metrics
    ):
        ...
        with patch("app.api.v1.analytics.get_current_user") as mock_get_user:
            ...
            with patch("app.api.v1.analytics.get_db") as mock_get_db:
                ...
                with patch(
                    ...
                    response = await client.get(
                        "/api-internal/v1/analytics/metrics/system?hours=48",
    ...
    @pytest.mark.asyncio
    async def test_get_system_metrics_non_admin_denied(
        self, client, auth_headers, mock_user
    ):
        ...
        with patch("app.api.v1.analytics.get_current_user") as mock_get_user:
            ...
            response = await client.get(
                "/api-internal/v1/analytics/metrics/system", headers=auth_headers
            )
    ...
    async def test_get_system_health_success(
        self, client, auth_headers, mock_user, sample_health_data
    ):
        """Test successful system health retrieval"""
        mock_analytics_service = Mock()
        mock_analytics_service.get_system_health = AsyncMock(
            return_value=Mock(**sample_health_data)
        )
        ...
        with patch("app.api.v1.analytics.get_current_user") as mock_get_user:
            ...
            with patch("app.api.v1.analytics.get_db") as mock_get_db:
                ...
                with patch(
                    ...
                    response = await client.get(
                        "/api-internal/v1/analytics/health", headers=auth_headers
                    )
    ...
    @pytest.mark.asyncio
    async def test_get_system_health_service_error(
        self, client, auth_headers, mock_user
    ):
    ...
    async def test_get_cost_analysis_success(self, client, auth_headers, mock_user):
        ...
        cost_analysis_data = {
            ...
            "cost_by_model": {"gpt-3.5-turbo": 2000, "gpt-4": 3000},
            "projected_monthly_cost": 15000,  # $150.00
            "period_days": 30,
        }

        mock_analytics_service = Mock()
        mock_analytics_service.get_cost_analysis = AsyncMock(
            return_value=Mock(**cost_analysis_data)
        )
        ...
        with patch("app.api.v1.analytics.get_current_user") as mock_get_user:
            ...
            with patch("app.api.v1.analytics.get_db") as mock_get_db:
                ...
                with patch(
                    ...
                    response = await client.get(
                        "/api-internal/v1/analytics/costs?days=30", headers=auth_headers
                    )
                    ...
                    mock_analytics_service.get_cost_analysis.assert_called_once_with(
                        days=30, user_id=mock_user["id"]
                    )

    @pytest.mark.asyncio
    async def test_get_system_cost_analysis_admin(
        self, client, admin_headers, mock_admin_user
    ):
        ...
        with patch("app.api.v1.analytics.get_current_user") as mock_get_user:
            ...
            with patch("app.api.v1.analytics.get_db") as mock_get_db:
                ...
                with patch(
                    ...
                    response = await client.get(
                        "/api-internal/v1/analytics/costs/system?days=7",
                        headers=admin_headers,
                    )
    ...
    async def test_get_endpoint_stats_success(self, client, auth_headers, mock_user):
        ...
        status_codes = {200: 220, 400: 20, 401: 5, 500: 5}

        model_stats = {"gpt-3.5-turbo": 100, "gpt-4": 50}
        ...
        with patch("app.api.v1.analytics.get_current_user") as mock_get_user:
            ...
            with patch("app.api.v1.analytics.get_db") as mock_get_db:
                ...
                with patch(
                    ...
                    response = await client.get(
                        "/api-internal/v1/analytics/endpoints", headers=auth_headers
                    )
            ...
            with patch("app.api.v1.analytics.get_db") as mock_get_db:
                ...
                mock_usage_data = [
                    (
                        ...
                        5000,
                        500,
                    ),  # date, requests, tokens, cost_cents
                ...
                response = await client.get(
                    "/api-internal/v1/analytics/usage-trends?days=7",
                    headers=auth_headers,
                )
    ...
    async def test_get_analytics_overview_success(
        ...
        mock_health = Mock(status="healthy", score=98)
        ...
        with patch("app.api.v1.analytics.get_current_user") as mock_get_user:
            ...
            with patch("app.api.v1.analytics.get_db") as mock_get_db:
                ...
                with patch(
                    ...
                    response = await client.get(
                        "/api-internal/v1/analytics/overview", headers=auth_headers
                    )
    ...
    async def test_get_module_analytics_success(self, client, auth_headers, mock_user):
        ...
        mock_modules = {
            "agent": Mock(initialized=True),
            "rag": Mock(initialized=True),
            "cache": Mock(initialized=False),
        }

        # Mock module with get_stats method
        mock_agent_stats = {"requests": 150, "conversations": 25}
        mock_modules["agent"].get_stats = Mock(return_value=mock_agent_stats)
        ...
        with patch("app.api.v1.analytics.get_current_user") as mock_get_user:
            ...
            with patch("app.api.v1.analytics.get_db") as mock_get_db:
                ...
                with patch(
                    "app.api.v1.analytics.module_manager"
                ) as mock_module_manager:
                    mock_module_manager.modules = mock_modules

                    response = await client.get(
                        "/api-internal/v1/analytics/modules", headers=auth_headers
                    )
                    ...
                    assert agent_module["initialized"] is True
                    assert agent_module["requests"] == 150

    @pytest.mark.asyncio
    async def test_get_module_analytics_with_errors(
        self, client, auth_headers, mock_user
    ):
        ...
        mock_modules["broken_module"].get_stats = Mock(
    ...
    async def test_analytics_service_unavailable(self, client, auth_headers, mock_user):
        ...
        with patch("app.api.v1.analytics.get_current_user") as mock_get_user:
            ...
            with patch(
                ...
                mock_get_analytics.side_effect = Exception(
                    "Analytics service unavailable"
                )

                response = await client.get(
                    "/api-internal/v1/analytics/metrics", headers=auth_headers
                )
    ...
    async def test_database_connection_error(self, client, auth_headers, mock_user):
        ...
        with patch("app.api.v1.analytics.get_current_user") as mock_get_user:
            ...
            with patch("app.api.v1.analytics.get_db") as mock_get_db:
                ...
                response = await client.get(
                    "/api-internal/v1/analytics/usage-trends", headers=auth_headers
                )
    ...
    async def test_cost_analysis_invalid_period(self, client, auth_headers, mock_user):
        ...
        for days in invalid_periods:
            response = await client.get(
                f"/api-internal/v1/analytics/costs?days={days}", headers=auth_headers
            )
