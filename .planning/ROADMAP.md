...
- [x] 04-02: Build Workflows route, navigation entry, operations console, workflow list, and health summaries.

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 04-03: Add schedule board, upcoming runs, disable/enable flows, and schedule health states.
...
- [x] 05-01: Expose step catalog schemas and validation endpoints.

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 05-02: Build Step Builder UI, trigger forms, step forms, validation summary, draft save, publish, and enable flows.
...
- [x] 07-03: Add API/event trigger foundations with auth, idempotency, and docs surface. (completed 2026-07-05)
